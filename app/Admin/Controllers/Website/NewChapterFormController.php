...
use App\Admin\Databases\Website\SiteFormNewChapter;
...
class NewChapterFormController extends Controller
{
    use ModelForm;
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('New chapter opening applications');
    ...
    {
        return Admin::grid(SiteFormNewChapter::class, function (Grid $grid) {
            $countries = array(
                'AF' => 'Afghanistan',
                'AL' => 'Albania',
                'DZ' => 'Algeria',
    ...
    {
        return Admin::form(SiteFormNewChapter::class, function (Form $form) {
            ...
            $form->saving(function (Form $form)
            {
                if (request('reply_msg') != null || empty(request('reply_msg')) == false)
                {
                    ...
                    Mail::send('mails.mailTmp1', $data, function ($m) use ($data) {
                        ...
                        $m->to($data['email'], $data['name'])->subject('New chapter opening application submit reply | Future City Summit');
                    });
                }
            });
        });
