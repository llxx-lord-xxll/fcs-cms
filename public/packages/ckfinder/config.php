...
$config['authentication'] = function () {
    ...
    $APP_KEY = str_after(env('APP_KEY'),'base64:');
...
$config['licenseName'] = 'Pranto';
$config['licenseKey']  = 'FBKH5GAA8LAML7WYLFWTCA9B4QGUY7VL';
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => '',
    'root'         => dirname(dirname($_SERVER['DOCUMENT_ROOT'])) . '\\fcs-web\\public\\uploads\\', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
